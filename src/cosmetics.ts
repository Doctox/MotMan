...
export const FRAMES: FrameDefinition[] = [
  ...
  { id: 'cadre-sauge', name: 'Sauge', description: 'Un double filet végétal apaisant.', pricePlumes: 120, rarity: 'commun', availability: 'epicerie' },
  { id: 'cadre-terracotta', name: 'Terre cuite', description: 'Deux lignes chaudes et délicates.', pricePlumes: 125, rarity: 'commun', availability: 'epicerie' },
  { id: 'cadre-encre', name: 'Encre', description: 'Un tracé profond aux reflets bleutés.', pricePlumes: 130, rarity: 'commun', availability: 'epicerie' },
  { id: 'cadre-laiton', name: 'Laiton', description: 'Un cercle sobre aux accents dorés.', pricePlumes: 135, rarity: 'commun', availability: 'epicerie' },
  { id: 'cadre-rosee', name: 'Rosée', description: 'Feuilles de sauge et perles de rosée.', asset: '/assets/frames/cadre-rosee.webp', pricePlumes: 160, rarity: 'singulier', availability: 'epicerie' },
  { id: 'cadre-coquelicot', name: 'Coquelicot', description: 'Pétales rouges sur ivoire.', asset: '/assets/frames/cadre-coquelicot.webp', pricePlumes: 170, rarity: 'singulier', availability: 'epicerie' },
  { id: 'cadre-porcelaine', name: 'Porcelaine', description: 'Fleurs cobalt et éclats de kintsugi.', asset: '/assets/frames/cadre-porcelaine.webp', pricePlumes: 180, rarity: 'singulier', availability: 'epicerie' },
  { id: 'cadre-herbier', name: 'Herbier', description: 'Fougères anciennes et fermoirs dorés.', asset: '/assets/frames/cadre-herbier.webp', pricePlumes: 210, rarity: 'rare', availability: 'epicerie' },
  { id: 'cadre-maree', name: 'Marée', description: 'Vagues sculptées et perle marine.', asset: '/assets/frames/cadre-maree.webp', pricePlumes: 230, rarity: 'rare', availability: 'epicerie' },
  { id: 'cadre-bibliotheque', name: 'Bibliothèque', description: 'Livres anciens et plume d’ivoire.', asset: '/assets/frames/cadre-bibliotheque.webp', pricePlumes: 250, rarity: 'rare', availability: 'epicerie' },
  { id: 'cadre-braise', name: 'Braise', description: 'Flammes de terre cuite et ambre.', asset: '/assets/frames/cadre-braise.webp', pricePlumes: 340, rarity: 'precieux', availability: 'epicerie' },
  { id: 'cadre-royal', name: 'Royal', description: 'Velours émeraude et joyaux couronnés.', asset: '/assets/frames/cadre-royal.webp', pricePlumes: 370, rarity: 'precieux', availability: 'epicerie' },
  { id: 'cadre-encrier', name: 'Encrier', description: 'Plumes d’or et encre nocturne.', asset: '/assets/frames/cadre-encrier.webp', pricePlumes: 400, rarity: 'precieux', availability: 'epicerie' },
  { id: 'cadre-clair-de-lune', name: 'Clair de lune', description: 'Croissant de lune et astres dorés.', asset: '/assets/frames/cadre-clair-de-lune.webp', pricePlumes: 520, rarity: 'exceptionnel', availability: 'epicerie' },
  { id: 'cadre-givre', name: 'Givre', description: 'Cristaux d’argent et saphirs glacés.', asset: '/assets/frames/cadre-givre.webp', pricePlumes: 560, rarity: 'exceptionnel', availability: 'epicerie' },
  { id: 'cadre-aurore', name: 'Aurore', description: 'Rubans célestes et soleil d’opale.', asset: '/assets/frames/cadre-aurore.webp', pricePlumes: 600, rarity: 'exceptionnel', availability: 'epicerie' },
  { id: 'cadre-constellation', name: 'Constellation', description: 'Orbite céleste et couronne d’étoiles.', asset: '/assets/frames/cadre-constellation.webp', pricePlumes: 780, rarity: 'legendaire', availability: 'epicerie' },
  { id: 'cadre-dragon-dore', name: 'Dragon doré', description: 'Gardien d’or serti d’émeraudes.', asset: '/assets/frames/cadre-dragon-dore.webp', pricePlumes: 840, rarity: 'legendaire', availability: 'epicerie' },
  { id: 'cadre-jardin-des-songes', name: 'Jardin des songes', description: 'Fleurs lumineuses et papillons de nuit.', asset: '/assets/frames/cadre-jardin-des-songes.webp', pricePlumes: 900, rarity: 'legendaire', availability: 'epicerie' },
]
...
export const ANIMATIONS: AnimationDefinition[] = [
  ...
  { id: 'eclat', name: 'Éclat', description: 'Un reflet doré parcourt doucement le portrait.', asset: '/assets/animations/lab/eclat.png', poster: '/assets/animations/lab/eclat-poster.webp', pricePlumes: 120, rarity: 'commun', availability: 'epicerie' },
  { id: 'etincelle', name: 'Étincelle', description: 'Une petite lumière s’ouvre puis se referme.', asset: '/assets/animations/lab/etincelle.png', poster: '/assets/animations/lab/etincelle-poster.webp', pricePlumes: 125, rarity: 'commun', availability: 'epicerie' },
  { id: 'poussiere-dor', name: 'Poussière d’or', description: 'Quelques grains lumineux dérivent sans insister.', asset: '/assets/animations/lab/poussiere-dor.png', poster: '/assets/animations/lab/poussiere-dor-poster.webp', pricePlumes: 130, rarity: 'commun', availability: 'epicerie' },
  { id: 'souffle', name: 'Souffle', description: 'Trois courants légers effleurent le portrait.', asset: '/assets/animations/lab/souffle.png', poster: '/assets/animations/lab/souffle-poster.webp', pricePlumes: 135, rarity: 'commun', availability: 'epicerie' },
  { id: 'halo', name: 'Halo', description: 'Un cercle doré respire autour de l’avatar.', asset: '/assets/animations/lab/halo.png', poster: '/assets/animations/lab/halo-poster.webp', pricePlumes: 140, rarity: 'commun', availability: 'epicerie' },
  { id: 'lucioles', name: 'Lucioles', description: 'Quelques lumières dérivent et s’éteignent doucement.', asset: '/assets/animations/lab/lucioles.png', poster: '/assets/animations/lab/lucioles-poster.webp', pricePlumes: 175, rarity: 'singulier', availability: 'epicerie' },
  { id: 'brume-irisee', name: 'Brume irisée', description: 'Des nappes opalines respirent doucement.', asset: '/assets/animations/lab/brume-irisee.png', poster: '/assets/animations/lab/brume-irisee-poster.webp', pricePlumes: 185, rarity: 'singulier', availability: 'epicerie' },
  { id: 'constellation', name: 'Constellation', description: 'De petites étoiles apparaissent puis s’effacent.', asset: '/assets/animations/lab/constellation.png', poster: '/assets/animations/lab/constellation-poster.webp', pricePlumes: 195, rarity: 'singulier', availability: 'epicerie' },
  { id: 'plume', name: 'Plume', description: 'Une plume légère descend en suivant le vent.', asset: '/assets/animations/lab/plume.png', poster: '/assets/animations/lab/plume-poster.webp', pricePlumes: 240, rarity: 'rare', availability: 'epicerie' },
  { id: 'feuille-automne', name: 'Feuilles d’automne', description: 'Une pluie cuivrée tourbillonne doucement.', asset: '/assets/animations/lab/feuille-automne.png', poster: '/assets/animations/lab/feuille-automne-poster.webp', pricePlumes: 255, rarity: 'rare', availability: 'epicerie' },
  { id: 'lune-vagabonde', name: 'Lune vagabonde', description: 'Une lune nacrée passe avec ses étoiles.', asset: '/assets/animations/lab/lune-vagabonde.png', poster: '/assets/animations/lab/lune-vagabonde-poster.webp', pricePlumes: 270, rarity: 'rare', availability: 'epicerie' },
  { id: 'rosee', name: 'Rosée', description: 'Une goutte fait naître une onde délicate.', asset: '/assets/animations/lab/rosee.png', poster: '/assets/animations/lab/rosee-poster.webp', pricePlumes: 370, rarity: 'precieux', availability: 'epicerie' },
  { id: 'prisme', name: 'Prisme', description: 'Des reflets irisés glissent sur le portrait.', asset: '/assets/animations/lab/prisme.png', poster: '/assets/animations/lab/prisme-poster.webp', pricePlumes: 390, rarity: 'precieux', availability: 'epicerie' },
  { id: 'ecume', name: 'Écume', description: 'Un ressac discret libère des bulles nacrées.', asset: '/assets/animations/lab/ecume.png', poster: '/assets/animations/lab/ecume-poster.webp', pricePlumes: 410, rarity: 'precieux', availability: 'epicerie' },
  { id: 'petales', name: 'Pétales', description: 'Une pluie légère traverse naturellement le portrait.', asset: '/assets/animations/lab/petales.png', poster: '/assets/animations/lab/petales-poster.webp', pricePlumes: 560, rarity: 'exceptionnel', availability: 'epicerie' },
  { id: 'papillons-du-songe', name: 'Papillons du songe', description: 'De petits papillons se croisent puis repartent.', asset: '/assets/animations/lab/papillons-du-songe.png', poster: '/assets/animations/lab/papillons-du-songe-poster.webp', pricePlumes: 590, rarity: 'exceptionnel', availability: 'epicerie' },
  { id: 'carpes-celestes', name: 'Carpes célestes', description: 'Deux carpes lumineuses nagent de concert.', asset: '/assets/animations/lab/carpes-celestes.png', poster: '/assets/animations/lab/carpes-celestes-poster.webp', pricePlumes: 620, rarity: 'exceptionnel', availability: 'epicerie' },
  { id: 'oiseau-de-lumiere', name: 'L’Oiseau de lumière', description: 'La lumière prend son envol puis se disperse.', asset: '/assets/animations/lab/oiseau-de-lumiere.png', poster: '/assets/animations/lab/oiseau-de-lumiere-poster.webp', pricePlumes: 820, rarity: 'legendaire', availability: 'epicerie' },
  { id: 'serpent-emeraude', name: 'Serpent d’émeraude', description: 'Une lumière verte s’incarne, ondule puis s’efface.', asset: '/assets/animations/lab/serpent-emeraude.png', poster: '/assets/animations/lab/serpent-emeraude-poster.webp', pricePlumes: 860, rarity: 'legendaire', availability: 'epicerie' },
  { id: 'dragon-solaire', name: 'Dragon solaire', description: 'La lumière forme un dragon avant de se disperser.', asset: '/assets/animations/lab/dragon-solaire.png', poster: '/assets/animations/lab/dragon-solaire-poster.webp', pricePlumes: 900, rarity: 'legendaire', availability: 'epicerie' },
]
