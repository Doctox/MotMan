    ...
    <section ref={dialogRef} className="mm-legal-panel" role="dialog" aria-modal="true" aria-label="Informations légales" tabIndex={-1}>
      ...
      <div className="mm-legal-scroll">
        {tab === 'privacy' ? <article>
          ...
          <h4>Jeunes joueurs</h4><p>MotMan s’adresse aux joueurs de 13 ans et plus et n’est pas destiné aux enfants. En France, lorsqu’un joueur a moins de 15 ans, la création et l’utilisation d’un compte en ligne nécessitent l’accord conjoint de l’enfant et d’un titulaire de l’autorité parentale.</p>
        </article> : null}
        {tab === 'terms' ? <article>
          ...
          <h4>Public et compte</h4><p>MotMan s’adresse aux joueurs de 13 ans et plus et n’est pas destiné aux enfants. En France, un joueur de moins de 15 ans doit utiliser le compte en ligne avec l’accord conjoint de l’enfant et d’un titulaire de l’autorité parentale. Chaque joueur doit protéger son compte et choisir un pseudo approprié.</p>
